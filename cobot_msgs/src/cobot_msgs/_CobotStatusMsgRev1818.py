...
"""autogenerated by genpy from cobot_msgs/CobotStatusMsgRev1818.msg. Do not edit."""
import sys
...
class CobotStatusMsgRev1818(genpy.Message):
  _md5sum = "7e44d872f4d434b02beab58b65d9cbb0"
  _type = "cobot_msgs/CobotStatusMsgRev1818"
...
float32[] pathPlan_x
float32[] pathPlan_y"""
  __slots__ = ['timestamp','loc_x','loc_y','orientation','particles_x','particles_y','particles_weight','locations_weight','currentNavCommand','obsAvDir_x','obsAvDir_y','pathBlocked','batteryVoltage','emergencyStop','cobotMode','currentCommand','navComplete','currentEdge','edgeProgress','edgeRemaining','edgeNavDuration','pathPlan_x','pathPlan_y']
  _slot_types = ['float64','float32','float32','float32','float32[]','float32[]','float32[]','float32[]','uint16','float32','float32','bool','float32','bool','int16','int16','bool','int32','float32','float32','float64','float32[]','float32[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       timestamp,loc_x,loc_y,orientation,particles_x,particles_y,particles_weight,locations_weight,currentNavCommand,obsAvDir_x,obsAvDir_y,pathBlocked,batteryVoltage,emergencyStop,cobotMode,currentCommand,navComplete,currentEdge,edgeProgress,edgeRemaining,edgeNavDuration,pathPlan_x,pathPlan_y
    ...
    """
    if args or kwds:
      super(CobotStatusMsgRev1818, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_H2fBfB2hBi2fd().pack(_x.currentNavCommand, _x.obsAvDir_x, _x.obsAvDir_y, _x.pathBlocked, _x.batteryVoltage, _x.emergencyStop, _x.cobotMode, _x.currentCommand, _x.navComplete, _x.currentEdge, _x.edgeProgress, _x.edgeRemaining, _x.edgeNavDuration))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.currentNavCommand, _x.obsAvDir_x, _x.obsAvDir_y, _x.pathBlocked, _x.batteryVoltage, _x.emergencyStop, _x.cobotMode, _x.currentCommand, _x.navComplete, _x.currentEdge, _x.edgeProgress, _x.edgeRemaining, _x.edgeNavDuration,) = _get_struct_H2fBfB2hBi2fd().unpack(str[start:end])
...
def _get_struct_d3f():
    ...
    return _struct_d3f
_struct_H2fBfB2hBi2fd = None
def _get_struct_H2fBfB2hBi2fd():
    global _struct_H2fBfB2hBi2fd
    if _struct_H2fBfB2hBi2fd is None:
        _struct_H2fBfB2hBi2fd = struct.Struct("<H2fBfB2hBi2fd")
    return _struct_H2fBfB2hBi2fd
