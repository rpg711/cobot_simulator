...
"""autogenerated by genpy from cobot_msgs/ExpectedLidarObsSrvRequest.msg. Do not edit."""
import sys
...
class ExpectedLidarObsSrvRequest(genpy.Message):
  _md5sum = "a3b5025402404ad2518665967b08a335"
  _type = "cobot_msgs/ExpectedLidarObsSrvRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ExpectedLidarObsSrvRequest, self).__init__(*args, **kwds)
...
def _get_struct_3d():
    ...
    return _struct_3d
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from cobot_msgs/ExpectedLidarObsSrvResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class ExpectedLidarObsSrvResponse(genpy.Message):
  _md5sum = "97623c0e08313039a47ded66d70350d2"
  _type = "cobot_msgs/ExpectedLidarObsSrvResponse"
  _has_header = False #flag to mark the presence of a Header object
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ExpectedLidarObsSrvResponse, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
...
def _get_struct_3I():
    ...
    return _struct_3I
class ExpectedLidarObsSrv(object):
  _type          = 'cobot_msgs/ExpectedLidarObsSrv'
  _md5sum = '8368a2e3a5a05248bd73f0d98911470e'
  _request_class  = ExpectedLidarObsSrvRequest
  _response_class = ExpectedLidarObsSrvResponse
