...
"""autogenerated by genpy from cobot_msgs/CobotCameraMsg.msg. Do not edit."""
import sys
...
class CobotCameraMsg(genpy.Message):
  ...
  _type = "cobot_msgs/CobotCameraMsg"
...
"""
  ...
  def serialize(self, buff):
    ...
    """
    try:
      buff.write(_get_struct_q().pack(self.numCameras))
      length = len(self.ip)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.numCameras,) = _get_struct_q().unpack(str[start:end])
      start = end
      end += 4
