...
"""autogenerated by genpy from cobot_msgs/CobotLocalizationMsgRev2043.msg. Do not edit."""
import sys
...
class CobotLocalizationMsgRev2043(genpy.Message):
  _md5sum = "88e4cd133e897255a68320aa8fedc7f7"
  _type = "cobot_msgs/CobotLocalizationMsgRev2043"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(CobotLocalizationMsgRev2043, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_d5f().pack(_x.timeStamp, _x.x, _x.y, _x.angle, _x.angleUncertainty, _x.locationUncertainty))
      _x = self.map
      length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.timeStamp, _x.x, _x.y, _x.angle, _x.angleUncertainty, _x.locationUncertainty,) = _get_struct_d5f().unpack(str[start:end])
      start = end
      end += 4
